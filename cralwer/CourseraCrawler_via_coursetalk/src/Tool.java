...
//			((JavascriptExecutor) driver).executeScript("window.stop();");
		...
		// assign course url (class central)
		data.url = targetURL;
		
		
		
		// 나중에 error url로 다시 돌려야할듯. 
		// title
...
//			course_info.appendChild(course_length);
	...
	public ArrayList<String> readCourseURL() throws Exception{
		...
		FileInputStream inputFile = new FileInputStream("./coursetalk_url_for_recrawling_20170719.txt");
